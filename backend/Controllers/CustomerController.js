...
exports.getRecentCustomers = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: 'Failed to fetch recent customers', error: error.message });
  }
};
...
exports.createCustomer = async (req, res) => {
  try {
    const { name, email, phone, address, city, state, postalCode, avatar } = req.body;
...
exports.searchCustomers = async (req, res) => {
  try {
    ...
    console.error(`Error searching customers with query "${req.query.q}":`, error);
